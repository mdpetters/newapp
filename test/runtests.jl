...
# !!! Main.UserApp is configured as an alias for Main.Newapp and you might encounter it in some tests
using Main.Newapp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Newapp tests" begin
  @includetests ARGS
end
